...
export const STARTER_BLADES = [
  {
    ...
    baseStats: { att: 85, def: 30, agi: 55, hp: 60 },
    color: 0xff3030,
  ...
  },
  {
    ...
    baseStats: { att: 35, def: 85, agi: 25, hp: 95 },
    color: 0x1e88ff,
  ...
  },
  {
    ...
    baseStats: { att: 55, def: 25, agi: 90, hp: 50 },
    color: 0x00e676,
  ...
  },
  {
    ...
    baseStats: { att: 60, def: 60, agi: 60, hp: 70 },
    color: 0xffd600,
...
export const PARTS_DB = [
  ...
  { id: "p_gyro_1", slot: "gyro", name: "Heavy Gyro", bonus: 15, unlockBattle: 1 },
  ...
  { id: "p_gyro_2", slot: "gyro", name: "Diamond Gyro", bonus: 25, unlockBattle: 3 },
  ...
  { id: "p_gyro_3", slot: "gyro", name: "Core Gyro", bonus: 40, unlockBattle: 5 }
];
